...
| [docs/formatting.md](docs/formatting.md) | 格式化：缩进、空白、行尾约定与批量重排的接受判据 |
| [docs/layout-scaffold.md](docs/layout-scaffold.md) | 布局脚手架 Helpers.Layout：构造器清单、L.card 控制键、id 契约 |
...
| [docs/release.md](docs/release.md) | 发布：本地 Maven 调试与远程仓库发布流程 |
