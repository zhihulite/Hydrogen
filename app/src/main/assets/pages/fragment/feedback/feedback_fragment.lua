-- pages/fragment/feedback/feedback_fragment.lua
-- 反馈页面 Fragment
...
function FeedbackFragment:buildFeedbackData()
  self.items = {
    ...
    { type = "title", title = "软件有点卡？", content = " (´；ω；`) 因为是基于 LuaJVM 框架跑的，性能有限可能会卡顿，请多担待啦～ 抱歉抱歉！" },
...
function FeedbackFragment:initListView()
  ...
  local divider = MaterialDividerItemDecoration(activity, SafeLinearLayoutManager.VERTICAL)
