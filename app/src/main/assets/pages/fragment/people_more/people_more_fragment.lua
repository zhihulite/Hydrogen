-- pages/fragment/people_more/people_more_fragment.lua
-- 用户更多内容
...
function PeopleMoreFragment:onCreate(params)
  ...
  if self.moreType:find("收藏") then
    self.model = require("models.collection.collection_tab_model"):new(self.userId)
   else
    self.model = require("models.user.people_more_model"):new(self.userId, self.moreType)
  end
end
...
function PeopleMoreFragment:collectAllBottomViews()
  return self:collectModelBottomViews(self.model)
end
