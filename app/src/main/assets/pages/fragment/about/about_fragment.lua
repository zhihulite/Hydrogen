-- pages/fragment/about/about_fragment.lua
-- 关于页面 Fragment
...
function AboutFragment:openQQChat(qq)
  ...
  if not ok then
    -- 没装 QQ 就打开网页版
    Helpers.UI.openUrl(string.format("https://wpa.qq.com/msgrd?v=3&uin=%s&site=qq&menu=yes", qq))
  end
end
